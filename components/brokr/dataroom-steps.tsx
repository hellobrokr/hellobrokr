...
export function DataroomSteps({ onSetupDataroom }: DataroomStepsProps) {
  return (
    <section id="datarooms" className="py-24 md:py-32 bg-white overflow-hidden">
              ...
              <div>
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                  ...
                  <span className="relative inline-block align-middle">
                    ...
                    <span className="relative z-10 inline-block px-6 py-2 bg-primary text-primary-foreground rounded-[22px] shadow-[0_4px_12px_rgba(0,0,0,0.15),_inset_0_1px_2px_rgba(255,255,255,0.6),_inset_0_-1px_1px_rgba(0,0,0,0.1)] border border-white/30 sm:py-0 sm:px-2.5">
                      faster.
                    </span>
                  </span>
                </h1>
