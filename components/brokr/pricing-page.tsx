                ...
                <table className="w-full min-w-[800px]">
                  <thead>
                    <tr className="border-b border-slate-200 sticky top-0 bg-white z-10">
                      <th className="sticky left-0 bg-white z-20 text-left py-3 px-3 font-semibold text-foreground text-sm border-r border-slate-200">
                        Features
                      </th>
                  ...
                  <tbody>
                    {allFeatures.map((feature) => (
                      <tr key={feature} className="border-b border-slate-100 last:border-b-0">
                        <td className="sticky left-0 bg-white py-3 px-3 font-medium text-foreground text-sm border-r border-slate-200">
                          {feature}
                        </td>
                        {pricingTiers.map((tier) => (
